...
<section class="gallery_archive">
    ...
    <div class="common_banner_header">
        <div class="image">
            ...
            <div class="banner_details">
                <div class="title">
                    <h1 class="primary_head_title">Gallery</h1>
                </div>
    ...
    <div class="gallery_archive_wrapper">
        <section class="gallery">
            <div class="container">
                <div class="gallery_wrapper">
                    <div class="gallery_image">
                        <div class="gallery_title">
                            <a href="gallery-innerpage.php">
                                <div class="gallery_main_title">
                                    <h3>Always try to do better for
                                        humanity</h3>
                                    <h5><i class="fa-solid fa-calendar me-2"></i>24th sep, 2024</h5>
                                    <h4>+12(images & videos)</h4>
                                </div>
                            </a>
                        </div>
                    </div>
